...
public class QueenTest {
    ...
    public void getPossibleMovesIfFieldIsEmpty() {
        ...
        PawnClass pawnClass = new PawnClass(Pawn.QUEEN, PawnColor.WHITE);
        Queen pawn = new Queen();
        ...
        PowerMockito.when(Board.isFieldNotNull(new Coordinates(1, 6))).thenReturn(false);
        PowerMockito.when(Board.isFieldNotNull(new Coordinates(2, 5))).thenReturn(false);
        PowerMockito.when(Board.isFieldNotNull(new Coordinates(3, 4))).thenReturn(false);
        PowerMockito.when(Board.isFieldNotNull(new Coordinates(4, 3))).thenReturn(false);
        PowerMockito.when(Board.isFieldNotNull(new Coordinates(5, 2))).thenReturn(false);
        PowerMockito.when(Board.isFieldNotNull(new Coordinates(6, 1))).thenReturn(false);
        PowerMockito.when(Board.isFieldNotNull(new Coordinates(7, 0))).thenReturn(false);
    ...
    public void getPossibleMovesIfFieldIsFull() {
        ...
        Coordinates coordinates = new Coordinates(0, 7);
        PawnClass pawnClass = new PawnClass(Pawn.QUEEN, PawnColor.WHITE);
        PawnClass enemyPawn = new PawnClass(Pawn.ROOK, PawnColor.BLACK);
        Queen pawn = new Queen();
        pawn.getPawnCoordinate(coordinates);
        ...
        PowerMockito.when(Board.isFieldNotNull(new Coordinates(4, 3))).thenReturn(true);
        PowerMockito.when(Board.getPawn(new Coordinates(4, 3))).thenReturn(enemyPawn);
        PowerMockito.when(Board.isThisSameColor(new Coordinates(4, 3), PawnColor.WHITE)).thenReturn(false);
        ...
        //Then
        Assert.assertEquals(12, possibleMoves.size());
    }
    ...
    public void getPossibleCheckIfFieldIsFull() {
        ...
        //Then
        Assert.assertEquals(4, possibleCheck.size());
    }
    ...
    public void getPossibleCheckIfFieldIsFullAndKingIsThisSameColor() {
        ...
        PowerMockito.when(Board.isFieldNotNull(new Coordinates(4, 3))).thenReturn(true);
        PowerMockito.when(Board.getPawn(new Coordinates(4, 3))).thenReturn(enemyPawn);
        PowerMockito.when(Board.isThisSameColor(new Coordinates(4, 3), PawnColor.WHITE)).thenReturn(true);
